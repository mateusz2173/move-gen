    ...
    fn make_move(&mut self, mv: &Move) -> Result<Option<Piece>> {
        ...
        let captured = match mv.kind() {
            ...
            MoveKind::EnPassant => {
                ...
                let enpass_sq = mv
                    .to()
                    .offset(0, if color == Color::White { -8 } else { 8 })
                    .expect("BUG: Invalid en passant square");

                self.add_piece_at(enpass_sq, from_piece, from_color)?;
...
impl Move {
    ...
    pub fn promotion(&self) -> Option<Piece> {
        match self.inner & 0b1111000000000000 {
            0b0001000000000000 => Some(Piece::Knight),
            0b1001000000000000 => Some(Piece::Bishop),
            0b0101000000000000 => Some(Piece::Rook),
            0b1101000000000000 => Some(Piece::Queen),
            _ => None,
        }
    }
    ...
    pub fn is_enpass_capture(&self) -> bool {
        self.inner & 0b1111000000000000 == 0b1010000000000000
    }
    ...
    pub fn is_double_pawn_push(&self) -> bool {
        self.inner & 0b1111000000000000 == 0b1000000000000000
    }

    pub fn is_king_castle(&self) -> bool {
        self.inner & 0b1111000000000000 == 0b0100000000000000
    }

    pub fn is_queen_castle(&self) -> bool {
        self.inner & 0b1111000000000000 == 0b1100000000000000
    }
    ...
    fn set_promotion(&mut self, promotion: Piece) {
        ...
        self.inner |= match promotion {
            ...
            Piece::Rook => 0b0101000000000000,
            Piece::Queen => 0b1101000000000000,
